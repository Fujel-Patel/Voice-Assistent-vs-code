  ...
  return (
    <>
      ...
      <SettingsSection title='Danger Zone' description='Conversation memory reset actions.' danger>
        {!confirming ? (
          <button
            className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-red-400 bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition-all"
          ...
          <div className="flex flex-col gap-3">
            <p className="text-sm text-muted-foreground">This will clear conversation history.</p>
            <div className="flex gap-2">
              <button
                className="px-4 py-2 rounded-lg text-sm font-medium bg-white/5 text-foreground border border-white/10 hover:bg-white/10 transition-colors"
                onClick={() => setConfirming(false)}
              >
                Cancel
              </button>
              <button
                className="px-4 py-2 rounded-lg text-sm font-medium text-red-400 bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition-all"
                onClick={() => {
                  onClearMemory?.('all')
                  setConfirming(false)
                }}
